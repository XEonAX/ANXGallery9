...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lcom/google/gson_nex/FieldNamingPolicy$2;

    const-string v1, "UPPER_CAMEL_CASE"

    const/4 v3, 0x1

    invoke-direct {v0, v1, v3}, Lcom/google/gson_nex/FieldNamingPolicy$2;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/google/gson_nex/FieldNamingPolicy;->UPPER_CAMEL_CASE:Lcom/google/gson_nex/FieldNamingPolicy;

    new-instance v0, Lcom/google/gson_nex/FieldNamingPolicy$3;

    const-string v1, "UPPER_CAMEL_CASE_WITH_SPACES"

    const/4 v4, 0x2

    invoke-direct {v0, v1, v4}, Lcom/google/gson_nex/FieldNamingPolicy$3;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/google/gson_nex/FieldNamingPolicy;->UPPER_CAMEL_CASE_WITH_SPACES:Lcom/google/gson_nex/FieldNamingPolicy;

    new-instance v0, Lcom/google/gson_nex/FieldNamingPolicy$4;

    const-string v1, "LOWER_CASE_WITH_UNDERSCORES"

    const/4 v5, 0x3

    invoke-direct {v0, v1, v5}, Lcom/google/gson_nex/FieldNamingPolicy$4;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/google/gson_nex/FieldNamingPolicy;->LOWER_CASE_WITH_UNDERSCORES:Lcom/google/gson_nex/FieldNamingPolicy;

    new-instance v0, Lcom/google/gson_nex/FieldNamingPolicy$5;

    const-string v1, "LOWER_CASE_WITH_DASHES"

    const/4 v6, 0x4

    invoke-direct {v0, v1, v6}, Lcom/google/gson_nex/FieldNamingPolicy$5;-><init>(Ljava/lang/String;I)V

    sput-object v0, Lcom/google/gson_nex/FieldNamingPolicy;->LOWER_CASE_WITH_DASHES:Lcom/google/gson_nex/FieldNamingPolicy;

    const/4 v0, 0x5

    new-array v0, v0, [Lcom/google/gson_nex/FieldNamingPolicy;

    sget-object v1, Lcom/google/gson_nex/FieldNamingPolicy;->IDENTITY:Lcom/google/gson_nex/FieldNamingPolicy;

    aput-object v1, v0, v2

    sget-object v1, Lcom/google/gson_nex/FieldNamingPolicy;->UPPER_CAMEL_CASE:Lcom/google/gson_nex/FieldNamingPolicy;

    aput-object v1, v0, v3

    sget-object v1, Lcom/google/gson_nex/FieldNamingPolicy;->UPPER_CAMEL_CASE_WITH_SPACES:Lcom/google/gson_nex/FieldNamingPolicy;

    aput-object v1, v0, v4

    sget-object v1, Lcom/google/gson_nex/FieldNamingPolicy;->LOWER_CASE_WITH_UNDERSCORES:Lcom/google/gson_nex/FieldNamingPolicy;

    aput-object v1, v0, v5

    sget-object v1, Lcom/google/gson_nex/FieldNamingPolicy;->LOWER_CASE_WITH_DASHES:Lcom/google/gson_nex/FieldNamingPolicy;

    aput-object v1, v0, v6

    sput-object v0, Lcom/google/gson_nex/FieldNamingPolicy;->$VALUES:[Lcom/google/gson_nex/FieldNamingPolicy;
...
.method synthetic constructor <init>(Ljava/lang/String;ILcom/google/gson_nex/FieldNamingPolicy$1;)V
    .locals 0
