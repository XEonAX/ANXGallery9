...
.method public execJob()Ljava/lang/Object;
    ...
    const-string v0, "FetchCloudControlDataJob"

    const-string v1, "Network is disconnected, skip exec."
    ...
    const-string v1, "exec job too frequently[time interval: %d ms], skip exec."
