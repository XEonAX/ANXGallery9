...
public final class NexAudioClip {
    ...
    public int hashCode() {
        int i = 0;
        int hashCode = ((((((((((((((((((((((((((((((((((((((((((((this.mClipID * 31) + this.mVisualClipID) * 31) + this.mClipType) * 31) + this.mTotalTime) * 31) + this.mStartTime) * 31) + this.mEndTime) * 31) + this.mStartTrimTime) * 31) + this.mEndTrimTime) * 31) + this.mClipPath.hashCode()) * 31) + this.mAudioOnOff) * 31) + this.mAutoEnvelop) * 31) + this.mClipVolume) * 31) + (this.mVolumeEnvelopeLevel != null ? Arrays.hashCode(this.mVolumeEnvelopeLevel) : 0)) * 31) + (this.mVolumeEnvelopeTime != null ? Arrays.hashCode(this.mVolumeEnvelopeTime) : 0)) * 31) + this.mVoiceChanger) * 31) + this.mCompressor) * 31) + this.mPitchFactor) * 31) + this.mMusicEffector) * 31) + this.mProcessorStrength) * 31) + this.mBassStrength) * 31) + this.mPanLeft) * 31) + this.mPanRight) * 31) + this.mSpeedControl) * 31;
