...
public interface INexAssetInstallCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements INexAssetInstallCallback {
        ...
        static final int TRANSACTION_onInstallFailed = 3;
        static final int TRANSACTION_onProgressInstall = 1;

        private static class a implements INexAssetInstallCallback {
            private IBinder a;
        ...
        public static INexAssetInstallCallback asInterface(IBinder iBinder) {
            ...
            return (queryLocalInterface == null || !(queryLocalInterface instanceof INexAssetInstallCallback)) ? new a(iBinder) : (INexAssetInstallCallback) queryLocalInterface;
        }
