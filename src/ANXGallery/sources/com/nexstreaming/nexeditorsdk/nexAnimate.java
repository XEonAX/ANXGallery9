...
public abstract class nexAnimate {
    ...
    protected static class Rotate extends nexAnimate {
        ...
        public float getAngleDegree(int i, float f, int i2) {
            float f2 = i2 == 3 ? this.mZAxisRotateDegree * timeRatio(i) : i2 == 1 ? this.mXAxisRotateDegree * timeRatio(i) : i2 == 2 ? this.mYAxisRotateDegree * timeRatio(i) : 0.0f;
            if (!this.mClockWise) {
                f2 *= -1.0f;
            }
            return (f + f2) % 360.0f;
    ...
    protected static class Scale extends nexAnimate {
        ...
        public float getScaledRatio(int i, float f, int i2) {
            if (this.mPath != null) {
                return f + this.mPath.getTranslatePosition(i2, timeRatio(i));
            }
            float f2 = 0.0f;
            if (i2 == 1) {
    ...
    public float timeRatio(int i) {
        ...
        return this.mTimeInterpolator != null ? this.mTimeInterpolator.getInterpolation(f2) : f2;
    }
}
