...
public class nexAssetStoreAppUtils {
    ...
    public static void moveGooglePlayAssetStoreLink(Context context) {
        ...
        sb.append(VendorList.getInstance().getAssetStoreAppPackageName(vendor));
    ...
    public static void moveGooglePlayKineMaster(Context context) {
        ...
        StringBuilder sb = new StringBuilder();
        sb.append("market://details?id=");
        sb.append(VendorList.getInstance().getKineMasterPackageName(vendor));
        intent.setData(Uri.parse(sb.toString()));
        context.startActivity(intent);
    }
        ...
        if (availableCategory != 0) {
            ...
            if (vendor.startsWith("TINNO") || i > 0) {
                if (i > 0) {
                    ...
                    String str2 = TAG;
                    StringBuilder sb = new StringBuilder();
                    sb.append("Set intent flag value=");
                    sb.append(i);
                    Log.d(str2, sb.toString());
                }
                String assetStoreAppPackageName = VendorList.getInstance().getAssetStoreAppPackageName(vendor);
                StringBuilder sb2 = new StringBuilder();
                sb2.append(VendorList.getInstance().getAssetStoreAppPackageName(vendor));
                sb2.append(".EnterActivity");
                intent.setClassName(assetStoreAppPackageName, sb2.toString());
                activity.startActivity(intent);
            } else {
                String assetStoreAppPackageName2 = VendorList.getInstance().getAssetStoreAppPackageName(vendor);
                StringBuilder sb3 = new StringBuilder();
                sb3.append(VendorList.getInstance().getAssetStoreAppPackageName(vendor));
                sb3.append(".AssetStoreService");
                intent.setClassName(assetStoreAppPackageName2, sb3.toString());
