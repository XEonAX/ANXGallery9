...
import com.nexstreaming.kminternal.kinemaster.config.EditorGlobal.Edition;

public final class BuildConfig {
    public static final String APPLICATION_ID = "com.nexstreaming.nexeditorsdk";
    public static final long BUILD_DATE = 1560757754503L;
    public static final String BUILD_TYPE = "xiaomiRelease";
    public static final boolean DEBUG = false;
    public static final String FLAVOR = "";
    public static final int KM_API_LEVEL = 0;
    public static final Edition KM_EDITION = Edition.PlayStore;
    ...
    public static final String KM_PROJECT = "Xiaomi";
