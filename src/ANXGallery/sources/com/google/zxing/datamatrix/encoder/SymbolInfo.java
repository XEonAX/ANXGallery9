...
public class SymbolInfo {
    ...
    static {
        ...
        SymbolInfo symbolInfo18 = new SymbolInfo(false, BaiduSceneResult.BRIDGE, 48, 18, 18, 4);
        SymbolInfo symbolInfo19 = new SymbolInfo(false, BaiduSceneResult.TAG_COUNT, 56, 20, 20, 4);
        SymbolInfo symbolInfo20 = new SymbolInfo(false, 174, 68, 22, 22, 4);
        SymbolInfo symbolInfo21 = new SymbolInfo(false, 204, 84, 24, 24, 4, BaiduSceneResult.TAEKWONDO, 42);
        SymbolInfo symbolInfo22 = new SymbolInfo(false, 280, BaiduSceneResult.STREET_VIEW, 14, 14, 16, BaiduSceneResult.CARTOON, 56);
        SymbolInfo symbolInfo23 = new SymbolInfo(false, 368, BaiduSceneResult.TAG_COUNT, 16, 16, 16, 92, 36);
        SymbolInfo symbolInfo24 = new SymbolInfo(false, 456, 192, 18, 18, 16, BaiduSceneResult.BRIDGE, 48);
        SymbolInfo symbolInfo25 = new SymbolInfo(false, 576, 224, 20, 20, 16, BaiduSceneResult.TAG_COUNT, 56);
        SymbolInfo symbolInfo26 = new SymbolInfo(false, 696, 272, 22, 22, 16, 174, 68);
        SymbolInfo symbolInfo27 = new SymbolInfo(false, 816, 336, 24, 24, 16, BaiduSceneResult.APPAREL, 56);
