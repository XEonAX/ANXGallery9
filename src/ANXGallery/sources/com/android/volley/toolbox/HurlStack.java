...
public class HurlStack extends BaseHttpStack {
    ...
    public HttpResponse executeRequest(Request<?> request, Map<String, String> map) throws IOException, AuthFailureError {
        ...
        if (responseCode != -1) {
            return !hasResponseBody(request.getMethod(), responseCode) ? new HttpResponse(responseCode, convertHeaders(openConnection.getHeaderFields())) : new HttpResponse(responseCode, convertHeaders(openConnection.getHeaderFields()), openConnection.getContentLength(), inputStreamFromConnection(openConnection));
        }
