...
public enum ConfigKey {
    ...
    StatDataUploadFrequency(BaiduSceneResult.MOTORCYCLE),
    StatDataUploadNum(BaiduSceneResult.STATION),
    StatDataProcessFrequency(122),
    StatDataSwitch(BaiduSceneResult.TRAIN),
    StatDataUploadWay(BaiduSceneResult.PIER),
    StatDataDeleteFrequency(BaiduSceneResult.TRAVEL_OTHER),
