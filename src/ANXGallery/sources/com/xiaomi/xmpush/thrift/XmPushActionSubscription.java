...
public class XmPushActionSubscription implements Serializable, Cloneable, TBase<XmPushActionSubscription, Object> {
    ...
    public int compareTo(XmPushActionSubscription xmPushActionSubscription) {
        ...
        int compareTo = Boolean.valueOf(isSetDebug()).compareTo(Boolean.valueOf(xmPushActionSubscription.isSetDebug()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (isSetDebug()) {
            int compareTo2 = TBaseHelper.compareTo(this.debug, xmPushActionSubscription.debug);
            if (compareTo2 != 0) {
                return compareTo2;
            }
        }
        int compareTo3 = Boolean.valueOf(isSetTarget()).compareTo(Boolean.valueOf(xmPushActionSubscription.isSetTarget()));
        if (compareTo3 != 0) {
            return compareTo3;
        }
        if (isSetTarget()) {
            int compareTo4 = TBaseHelper.compareTo((Comparable) this.target, (Comparable) xmPushActionSubscription.target);
            if (compareTo4 != 0) {
                return compareTo4;
            }
        }
        int compareTo5 = Boolean.valueOf(isSetId()).compareTo(Boolean.valueOf(xmPushActionSubscription.isSetId()));
        if (compareTo5 != 0) {
            return compareTo5;
        }
        if (isSetId()) {
            int compareTo6 = TBaseHelper.compareTo(this.id, xmPushActionSubscription.id);
            if (compareTo6 != 0) {
                return compareTo6;
            }
        }
        int compareTo7 = Boolean.valueOf(isSetAppId()).compareTo(Boolean.valueOf(xmPushActionSubscription.isSetAppId()));
        if (compareTo7 != 0) {
            return compareTo7;
        }
        if (isSetAppId()) {
            int compareTo8 = TBaseHelper.compareTo(this.appId, xmPushActionSubscription.appId);
            if (compareTo8 != 0) {
                return compareTo8;
            }
        }
        int compareTo9 = Boolean.valueOf(isSetTopic()).compareTo(Boolean.valueOf(xmPushActionSubscription.isSetTopic()));
        if (compareTo9 != 0) {
            return compareTo9;
        }
        if (isSetTopic()) {
            int compareTo10 = TBaseHelper.compareTo(this.topic, xmPushActionSubscription.topic);
            if (compareTo10 != 0) {
                return compareTo10;
            }
        }
        int compareTo11 = Boolean.valueOf(isSetPackageName()).compareTo(Boolean.valueOf(xmPushActionSubscription.isSetPackageName()));
        if (compareTo11 != 0) {
            return compareTo11;
        }
        if (isSetPackageName()) {
            int compareTo12 = TBaseHelper.compareTo(this.packageName, xmPushActionSubscription.packageName);
            if (compareTo12 != 0) {
                return compareTo12;
            }
        }
        int compareTo13 = Boolean.valueOf(isSetCategory()).compareTo(Boolean.valueOf(xmPushActionSubscription.isSetCategory()));
        if (compareTo13 != 0) {
            return compareTo13;
        }
        if (isSetCategory()) {
            int compareTo14 = TBaseHelper.compareTo(this.category, xmPushActionSubscription.category);
            if (compareTo14 != 0) {
                return compareTo14;
            }
        }
        int compareTo15 = Boolean.valueOf(isSetAliases()).compareTo(Boolean.valueOf(xmPushActionSubscription.isSetAliases()));
        if (compareTo15 != 0) {
            return compareTo15;
        }
        if (isSetAliases()) {
            int compareTo16 = TBaseHelper.compareTo((List) this.aliases, (List) xmPushActionSubscription.aliases);
            if (compareTo16 != 0) {
                return compareTo16;
            }
        }
    ...
    public boolean equals(XmPushActionSubscription xmPushActionSubscription) {
        ...
        return (!isSetAliases && !isSetAliases2) || (isSetAliases && isSetAliases2 && this.aliases.equals(xmPushActionSubscription.aliases));
    }
