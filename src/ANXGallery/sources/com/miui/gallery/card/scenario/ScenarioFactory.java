...
public class ScenarioFactory {
    ...
    public static Scenario createCloudTimeScenario(CloudTimeScenarioRule cloudTimeScenarioRule) {
    ...
    public static Scenario createLocalScenario(ScenarioRule scenarioRule) {
        if (scenarioRule != null) {
            Class cls = (Class) sScenarioClass.get(scenarioRule.getScenarioId());
            if (cls != null) {
                try {
