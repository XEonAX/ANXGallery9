...
public class BaiduSceneResult implements ISceneResult {
    ...
    private void initThresholds() {
        ...
        this.tagThresholds[126] = 0.001f;
        this.tagThresholds[127] = 0.001f;
        this.tagThresholds[128] = 0.001f;
        this.tagThresholds[129] = 0.001f;
        this.tagThresholds[130] = 0.001f;
        this.tagThresholds[131] = 0.001f;
        this.tagThresholds[132] = 0.001f;
        this.tagThresholds[133] = 0.001f;
        this.tagThresholds[134] = 0.001f;
        this.tagThresholds[135] = 0.001f;
    }
    ...
    public List<Integer> getValidTopKTag(int i) {
        ...
        if (this.classProb != null && this.classProb.length == this.classNum && i > 0 && i < this.classNum) {
            float[] copyOf = Arrays.copyOf(this.classProb, this.classProb.length);
            for (int i2 = 0; i2 < copyOf.length; i2++) {
                if (copyOf[i2] < this.tagThresholds[i2]) {
                    copyOf[i2] = 0.0f;
                }
            }
            for (int i3 : getTopKIndex(copyOf, i)) {
                if (copyOf[i3] > 0.0f) {
