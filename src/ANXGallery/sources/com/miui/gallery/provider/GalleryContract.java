...
public class GalleryContract {
    ...
    public interface Album {
        public static final Long[] ALL_SYSTEM_ALBUM_SERVER_IDS = {Long.valueOf(-2147483647L), Long.valueOf(-2147483645), Long.valueOf(-2147483644), Long.valueOf(-2147483646), Long.valueOf(1), Long.valueOf(2), Long.valueOf(-2147483642), Long.valueOf(-2147483643), Long.valueOf(1000), Long.valueOf(4)};
        public static final int[] ALL_VIRTUAL_ALBUM_IDS = {Integer.MAX_VALUE, 2147483646, 2147483645, 2147483644, 2147483643, 2147483642};
    ...
    public interface Common {
        ...
        public static final Uri URI_COLLAGE_FROM_PICKER = GalleryContract.HTTPS_AUTHORITY_URI.buildUpon().appendPath("collage_from_picker").build();
    ...
    public interface PeopleFace {
        ...
        public static final Uri PEOPLE_SNAPSHOT_URI = GalleryContract.AUTHORITY_URI.buildUpon().appendPath("people_snapshot").build();
