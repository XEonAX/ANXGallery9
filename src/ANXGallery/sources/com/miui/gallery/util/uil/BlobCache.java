...
public class BlobCache implements Closeable {
    ...
    public BlobCache(String str, int i, int i2, boolean z, int i3) throws IOException {
        ...
        sb.append(str);
        sb.append(".idx");
        this.mIndexFile = new RandomAccessFile(sb.toString(), "rw");
        StringBuilder sb2 = new StringBuilder();
        sb2.append(str);
        sb2.append(".0");
        this.mDataFile0 = new RandomAccessFile(sb2.toString(), "rw");
        StringBuilder sb3 = new StringBuilder();
        sb3.append(str);
        sb3.append(".1");
        this.mDataFile1 = new RandomAccessFile(sb3.toString(), "rw");
        this.mVersion = i3;
        if (z || !loadIndex()) {
            resetCache(i, i2);
            if (!loadIndex()) {
    ...
    public static void deleteFiles(String str) {
        ...
        sb.append(str);
        sb.append(".idx");
        deleteFileSilently(sb.toString());
        StringBuilder sb2 = new StringBuilder();
        sb2.append(str);
        sb2.append(".0");
        deleteFileSilently(sb2.toString());
        StringBuilder sb3 = new StringBuilder();
        sb3.append(str);
        sb3.append(".1");
        deleteFileSilently(sb3.toString());
    }
