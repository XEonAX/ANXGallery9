...
public class MosaicEntityTriangleRect extends MosaicEntityRely {
    public MosaicEntityTriangleRect(String str, String str2) {
        super(str, str2, TYPE.TRIANGLE_RECT);
    }
    ...
    public MosaicShaderHolder generateShader(Bitmap bitmap, float f, Matrix matrix) {
        ...
        if (bitmap.getWidth() < round || bitmap.getHeight() < round) {
            return new MosaicShaderHolder(new BitmapShader(bitmap, TileMode.CLAMP, TileMode.CLAMP), TYPE.TRIANGLE_RECT);
        }
        ...
        Log.d("MosaicEntityTriangleRect", "allocate cache costs %dms", (Object) Long.valueOf(System.currentTimeMillis() - currentTimeMillis));
        int i = 0;
        ...
        Log.d("MosaicEntityTriangleRect", "init cache costs %dms", (Object) Long.valueOf(System.currentTimeMillis() - currentTimeMillis));
        ...
        Log.d("MosaicEntityTriangleRect", "generate pixels costs %dms", (Object) Long.valueOf(System.currentTimeMillis() - currentTimeMillis));
        Bitmap createBitmap = Bitmap.createBitmap(iArr3, bitmap.getWidth(), bitmap.getHeight(), Config.ARGB_8888);
        Log.d("MosaicEntityTriangleRect", "finish costs %dms", (Object) Long.valueOf(System.currentTimeMillis() - currentTimeMillis));
        return new MosaicShaderHolder(new BitmapShader(createBitmap, TileMode.CLAMP, TileMode.CLAMP), TYPE.TRIANGLE_RECT);
    }
}
