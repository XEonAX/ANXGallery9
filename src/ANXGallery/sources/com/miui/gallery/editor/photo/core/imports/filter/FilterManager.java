...
public class FilterManager {
    static List<FilterAdjust> getAdjustData() {
        FilterAdjust filterAdjust = new FilterAdjust(0, 10, GalleryApp.sGetAndroidContext().getString(R.string.adjust_brightness), R.drawable.adjust_brightness, true);
        FilterAdjust filterAdjust2 = new FilterAdjust(3, 10, GalleryApp.sGetAndroidContext().getString(R.string.adjust_sharpen), R.drawable.adjust_sharpen, false);
        FilterAdjust filterAdjust3 = new FilterAdjust(1, 10, GalleryApp.sGetAndroidContext().getString(R.string.adjust_contrast), R.drawable.adjust_contrast, true);
        FilterAdjust filterAdjust4 = new FilterAdjust(2, 10, GalleryApp.sGetAndroidContext().getString(R.string.adjust_saturation), R.drawable.adjust_saturation, true);
        FilterAdjust filterAdjust5 = new FilterAdjust(4, 10, GalleryApp.sGetAndroidContext().getString(R.string.adjust_vignette), R.drawable.adjust_vignette, false);
        return Arrays.asList(new FilterAdjust[]{filterAdjust, filterAdjust2, filterAdjust3, filterAdjust4, filterAdjust5});
    }
    ...
    static List<FilterCategoryData> getFilterCategory() {
        ...
        if (!BuildUtil.isInternational() || !Settings.getRegion().endsWith("IN")) {
            FilterCategoryData filterCategoryData = new FilterCategoryData(2, GalleryApp.sGetAndroidContext().getString(R.string.filter_category_portrait), GalleryApp.sGetAndroidContext().getResources().getColor(R.color.filter_category_people), GalleryApp.sGetAndroidContext().getResources().getColor(R.color.filter_category_people_male), 4);
            arrayList.add(filterCategoryData);
        } else {
            FilterCategoryData filterCategoryData2 = new FilterCategoryData(5, GalleryApp.sGetAndroidContext().getString(R.string.filter_category_portrait), GalleryApp.sGetAndroidContext().getResources().getColor(R.color.filter_category_people_india), GalleryApp.sGetAndroidContext().getResources().getColor(R.color.filter_category_people_india_male), 5);
            arrayList.add(filterCategoryData2);
        }
    ...
    static List<FilterItem> getFiltersByCategory(int i) {
        switch (i) {
            ...
            default:
                ...
                sb.append("not support filterCategory:");
                sb.append(i);
    ...
    private static ArrayList<FilterItem> getSkyFilterItem() {
        ...
        FilterItem filterItem = new FilterItem(true, "filter_sky_sunny", GalleryApp.sGetAndroidContext().getString(R.string.filter_sky_sunny), R.drawable.filter_sky_sunny, 80);
        arrayList.add(filterItem);
        FilterItem filterItem2 = new FilterItem(true, "filter_sky_cloudy", GalleryApp.sGetAndroidContext().getString(R.string.filter_sky_cloudy), R.drawable.filter_sky_cloudy, 80);
        arrayList.add(filterItem2);
        FilterItem filterItem3 = new FilterItem(true, "filter_sky_rainbow", GalleryApp.sGetAndroidContext().getString(R.string.filter_sky_rainbow), R.drawable.filter_sky_rainbow, 80);
        arrayList.add(filterItem3);
        FilterItem filterItem4 = new FilterItem(true, "filter_sky_glow", GalleryApp.sGetAndroidContext().getString(R.string.filter_sky_glow), R.drawable.filter_sky_glow, 80);
        arrayList.add(filterItem4);
        FilterItem filterItem5 = new FilterItem(true, "filter_sky_dusk", GalleryApp.sGetAndroidContext().getString(R.string.filter_sky_dusk), R.drawable.filter_sky_dusk, 100);
        arrayList.add(filterItem5);
        FilterItem filterItem6 = new FilterItem(true, "filter_sky_sunset", GalleryApp.sGetAndroidContext().getString(R.string.filter_sky_sunset), R.drawable.filter_sky_sunset, 100);
