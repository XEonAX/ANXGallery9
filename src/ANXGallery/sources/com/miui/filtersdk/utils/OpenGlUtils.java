...
public class OpenGlUtils {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:14:0x0024 A[ExcHandler: all (th java.lang.Throwable), Splitter:B:3:0x000d] */
    ...
    public static int loadTexture(Context context, String str) {
        ...
        Log.e("OpenGlUtils", String.format("loadTexture failed,path:%s", new Object[]{str}));
        return -1;
    }
