...
public class NvAndroidThumbnail {
    ...
    public static Bitmap createThumbnail(Context context, String str, boolean z, int i, int i2) {
        ...
        int i3 = 0;
        Cursor query = z ? contentResolver.query(Media.EXTERNAL_CONTENT_URI, new String[]{"_id"}, "_data=?", new String[]{str}, null) : contentResolver.query(Images.Media.EXTERNAL_CONTENT_URI, new String[]{"_id"}, "_data=?", new String[]{str}, null);
        if (query != null) {
            if (query.getCount() == 0 || !query.moveToFirst()) {
                ...
                if (columnIndex >= 0) {
                    ...
                    query.close();
                    Cursor query2 = z ? contentResolver.query(Thumbnails.EXTERNAL_CONTENT_URI, new String[]{"_data"}, "video_id=?", new String[]{String.valueOf(j)}, null) : contentResolver.query(Images.Thumbnails.EXTERNAL_CONTENT_URI, new String[]{"_data"}, "image_id=?", new String[]{String.valueOf(j)}, null);
                    if (query2 != null) {
                    ...
                    Bitmap thumbnail = z ? Thumbnails.getThumbnail(contentResolver, j, 1, null) : Images.Thumbnails.getThumbnail(contentResolver, j, 1, null);
                    if (thumbnail == null) {
