...
final class SdkErrorInstrumentation extends Instrumentation implements SdkConstants {
    ...
    /* JADX WARNING: Incorrect type for immutable var: ssa=java.lang.Class<?>, code=java.lang.Class, for r16v0, types: [java.lang.Class<?>, java.lang.Class] */
    public Activity newActivity(Class cls, Context context, IBinder iBinder, Application application, Intent intent, ActivityInfo activityInfo, CharSequence charSequence, Activity activity, String str, Object obj) throws InstantiationException, IllegalAccessException {
        ...
        if (!cls.getSimpleName().startsWith("SdkError")) {
            ...
            intent3.putExtra("com.miui.sdk.error", this.mError);
            cls2 = cls3;
            intent2 = intent3;
        } else {
            cls2 = cls;
