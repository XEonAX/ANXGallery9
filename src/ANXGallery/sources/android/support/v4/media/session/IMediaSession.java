            ...
            if (i == 51) {
                ...
                switch (i) {
                    ...
                    case 2:
                        ...
                        boolean sendMediaButton = sendMediaButton(r1);
                        parcel2.writeNoException();
                    ...
                    case 14:
                        ...
                        playFromMediaId(readString2, r1);
                        parcel2.writeNoException();
                        return true;
                    case 15:
                        parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    ...
                    case 26:
                        ...
                        sendCustomAction(readString4, r1);
                        parcel2.writeNoException();
                        return true;
                    case 27:
                        parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    ...
                    case 34:
                        ...
                        prepareFromMediaId(readString5, r1);
                        parcel2.writeNoException();
                        return true;
                    case 35:
                        parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                        ...
                        prepareFromSearch(readString6, r1);
                        parcel2.writeNoException();
                        return true;
                    case 36:
                        parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    ...
                    case 38:
                        ...
                        parcel2.writeNoException();
                        parcel2.writeInt(isShuffleModeEnabledRemoved);
                        return true;
                    case 39:
                        parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                    ...
                    case 45:
                        ...
                        parcel2.writeNoException();
                        parcel2.writeInt(isCaptioningEnabled);
                        return true;
                    case 46:
                        parcel.enforceInterface("android.support.v4.media.session.IMediaSession");
                        if (parcel.readInt() != 0) {
