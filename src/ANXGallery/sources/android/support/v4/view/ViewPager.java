        ...
        for (int i13 = 0; i13 < childCount; i13++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isDecor) {
                    ...
                    int i15 = layoutParams.gravity & BaiduSceneResult.STREET_VIEW;
                    if (i14 == 1) {
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8) {
                ...
                if (layoutParams2 == null || !layoutParams2.isDecor) {
                    childAt2.measure(MeasureSpec.makeMeasureSpec((int) (((float) i7) * layoutParams2.widthFactor), 1073741824), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                    ...
                    for (int i7 = this.mCurItem - 1; i7 >= 0; i7--) {
                        if (f < paddingLeft || i7 >= max) {
                            if (itemInfo4 == null || i7 != itemInfo4.position) {
                                ...
                                i6++;
                                if (i5 >= 0) {
                                    itemInfo3 = (ItemInfo) this.mItems.get(i5);
                                    itemInfo4 = itemInfo3;
                                }
                            } else {
