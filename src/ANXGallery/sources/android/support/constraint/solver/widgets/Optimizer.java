    ...
    static boolean applyChainOptimized(ConstraintWidgetContainer constraintWidgetContainer, LinearSystem linearSystem, int i, int i2, ChainHead chainHead) {
        ...
        while (!z5) {
            ...
            if (constraintWidget9.getVisibility() != 8) {
                i5++;
                f3 = i3 == 0 ? f3 + ((float) constraintWidget9.getWidth()) : f3 + ((float) constraintWidget9.getHeight());
        ...
        if (i4 <= 0 || i4 != i5) {
            ...
            if (z4) {
                ...
                float biasPercent = f5 + ((f7 - f) * constraintWidget12.getBiasPercent(i3));
                while (constraintWidget12 != null) {
                    ...
                    if (constraintWidget13 != null || constraintWidget12 == constraintWidget3) {
                        float width = i3 == 0 ? (float) constraintWidget12.getWidth() : (float) constraintWidget12.getHeight();
                        ...
                        float f8 = margin + width;
                        constraintWidget12.mListAnchors[i6].getResolutionNode().resolve(resolutionNode.resolvedTarget, f8);
                        constraintWidget12.mListAnchors[i2].getResolutionNode().addResolvedValue(linearSystem3);
                        constraintWidget12.mListAnchors[i6].getResolutionNode().addResolvedValue(linearSystem3);
                        biasPercent = f8 + ((float) constraintWidget12.mListAnchors[i6].getMargin());
                    }
                ...
                if (z2 || z) {
                    ...
                    float f9 = f7 / ((float) (i5 + 1));
                    if (z) {
                        f9 = i5 > 1 ? f7 / ((float) (i5 - 1)) : f7 / 2.0f;
                    }
                    ...
                    while (constraintWidget14 != null) {
                        ...
                        if (constraintWidget15 != null || constraintWidget14 == constraintWidget3) {
                            float width2 = i3 == 0 ? (float) constraintWidget14.getWidth() : (float) constraintWidget14.getHeight();
                            ...
                            constraintWidget14.mListAnchors[i6].getResolutionNode().resolve(resolutionNode.resolvedTarget, f10 + width2);
                            constraintWidget14.mListAnchors[i2].getResolutionNode().addResolvedValue(linearSystem3);
                            constraintWidget14.mListAnchors[i6].getResolutionNode().addResolvedValue(linearSystem3);
                            f10 += width2 + ((float) constraintWidget14.mListAnchors[i6].getMargin());
            ...
            while (constraintWidget16 != null) {
                ...
                if (constraintWidget17 != null || constraintWidget16 == constraintWidget3) {
                    float f12 = f11 / ((float) i4);
                    if (f2 > 0.0f) {
                        f12 = constraintWidget16.mWeight[i3] == -1.0f ? 0.0f : (constraintWidget16.mWeight[i3] * f11) / f2;
                    }
                    ...
                    float f13 = margin2 + f12;
                    constraintWidget16.mListAnchors[i6].getResolutionNode().resolve(resolutionNode.resolvedTarget, f13);
                    LinearSystem linearSystem4 = linearSystem;
                    constraintWidget16.mListAnchors[i2].getResolutionNode().addResolvedValue(linearSystem4);
                    constraintWidget16.mListAnchors[i6].getResolutionNode().addResolvedValue(linearSystem4);
                    f5 = f13 + ((float) constraintWidget16.mListAnchors[i6].getMargin());
                } else {
