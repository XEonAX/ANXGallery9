...
public class RecyclerView extends ViewGroup implements NestedScrollingChild2 {
    ...
    public final class Recycler {
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                if ((RecyclerView.this.mAdapter != null && access$900 && RecyclerView.this.mAdapter.onFailedToRecycleView(viewHolder)) || viewHolder.isRecyclable()) {
    ...
    class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i2, int i3, int i4) {
            ...
            return Math.min(i5, nexProject.kAutoThemeTransitionDuration);
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                if (RecyclerView.this.mAdapter != null) {
                    ...
                    if (i6 != 0) {
                        i4 = RecyclerView.this.mLayout.scrollHorizontallyBy(i6, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        i3 = i6 - i4;
                    } else {
                        i4 = 0;
                        i3 = 0;
                    ...
                    if (i7 != 0) {
                        i2 = RecyclerView.this.mLayout.scrollVerticallyBy(i7, RecyclerView.this.mRecycler, RecyclerView.this.mState);
                        i = i7 - i2;
                    } else {
                        i2 = 0;
                        i = 0;
                    ...
                    if (smoothScroller != null && !smoothScroller.isPendingInitialRun() && smoothScroller.isRunning()) {
                        ...
                        if (itemCount == 0) {
                            ...
                            smoothScroller.onAnimation(i6 - i3, i7 - i);
                        } else {
                            smoothScroller.onAnimation(i6 - i3, i7 - i);
                        }
                    }
                ...
                if (!RecyclerView.this.dispatchNestedScroll(i4, i2, i3, i, null, 1) && !(i3 == 0 && i == 0)) {
                    ...
                    if (i3 != currX) {
                        ...
                        if (i != currY) {
                            ...
                            if ((i5 != 0 || i3 == currX || overScroller.getFinalX() == 0) && (currVelocity != 0 || i == currY || overScroller.getFinalY() == 0)) {
                ...
                boolean z = (i6 == 0 && i7 == 0) || (i6 != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && i4 == i6) || (i7 != 0 && RecyclerView.this.mLayout.canScrollVertically() && i2 == i7);
    ...
    public View focusSearch(View view, int i) {
        ...
        if (!z2 || !(i == 2 || i == 1)) {
            ...
            if (this.mLayout.canScrollVertically()) {
                int i2 = i == 2 ? BaiduSceneResult.VISA : 33;
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (this.mLayout != null && !this.mLayoutFrozen && motionEvent.getAction() == 8) {
            if ((motionEvent.getSource() & 2) != 0) {
                ...
                if ((motionEvent.getSource() & nexEngine.ExportHEVCMainTierLevel61) != 0) {
    ...
    public boolean scrollByInternal(int i, int i2, MotionEvent motionEvent) {
        ...
        if (dispatchNestedScroll(i6, i4, i5, i3, this.mScrollOffset, 0)) {
