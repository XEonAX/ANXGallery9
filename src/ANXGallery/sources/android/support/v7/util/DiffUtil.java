        ...
        while (i19 <= i16) {
            ...
            while (i21 <= i19) {
                if (i21 != i20) {
                    ...
                    int i24 = i5 + i21;
                    iArr3[i24] = i8;
                    if (z3 || i21 < (i15 - i19) + 1 || i21 > (i15 + i19) - 1 || iArr3[i24] < iArr4[i24]) {
                        i21 += 2;
                        i16 = i23;
                        i12 = i11;
                        i13 = i10;
            ...
            for (int i28 = i20; i28 <= i19; i28 += 2) {
                ...
                if (i29 != i19 + i15) {
                    ...
                    int i31 = i5 + i29;
                    iArr4[i31] = i6;
                    if (!z3 || i29 < i20 || i29 > i19 || iArr3[i31] < iArr4[i31]) {
                    } else {
                        Snake snake2 = new Snake();
                        snake2.x = iArr4[i31];
                        snake2.y = snake2.x - i29;
                        snake2.size = iArr3[i31] - iArr4[i31];
                        snake2.removal = z;
                        snake2.reverse = true;
                        return snake2;
                    }
