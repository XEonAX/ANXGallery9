...
.method private addInternal(IIILjava/lang/CharSequence;)Landroid/view/MenuItem;
    ...
    invoke-virtual {v9, p1}, Lcom/miui/gallery/view/menu/MenuItemImpl;->setMenuInfo(Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    invoke-static {p2, v8}, Lcom/miui/gallery/view/menu/MenuBuilder;->findInsertIndex(Ljava/util/ArrayList;I)I
...
.method public addSubMenu(IIILjava/lang/CharSequence;)Landroid/view/SubMenu;
    ...
    invoke-direct {p2, p3, p0, p1}, Lcom/miui/gallery/view/menu/SubMenuBuilder;-><init>(Landroid/content/Context;Lcom/miui/gallery/view/menu/MenuBuilder;Lcom/miui/gallery/view/menu/MenuItemImpl;)V

    invoke-virtual {p1, p2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->setSubMenu(Lcom/miui/gallery/view/menu/SubMenuBuilder;)V
...
.method public findItem(I)Landroid/view/MenuItem;
    ...
    invoke-virtual {v2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getItemId()I
    ...
    :cond_0
    invoke-virtual {v2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->hasSubMenu()Z

    move-result v3

    if-eqz v3, :cond_1

    invoke-virtual {v2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getSubMenu()Landroid/view/SubMenu;
...
.method findItemWithShortcutForKey(ILandroid/view/KeyEvent;)Lcom/miui/gallery/view/menu/MenuItemImpl;
    ...
    invoke-virtual {v4}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getAlphabeticShortcut()C
    ...
    :cond_3
    invoke-virtual {v4}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getNumericShortcut()C
...
.method findItemsWithShortcutForKey(Ljava/util/List;ILandroid/view/KeyEvent;)V
    ...
    invoke-virtual {v5}, Lcom/miui/gallery/view/menu/MenuItemImpl;->hasSubMenu()Z

    move-result v6

    if-eqz v6, :cond_2

    invoke-virtual {v5}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getSubMenu()Landroid/view/SubMenu;
    ...
    invoke-virtual {v5}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getAlphabeticShortcut()C
    ...
    :cond_3
    invoke-virtual {v5}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getNumericShortcut()C
    ...
    :cond_4
    invoke-virtual {v5}, Lcom/miui/gallery/view/menu/MenuItemImpl;->isEnabled()Z
...
.method public flagActionItems()V
    ...
    iget-boolean v0, p0, Lcom/miui/gallery/view/menu/MenuBuilder;->mIsActionItemsStale:Z
    ...
    check-cast v4, Lcom/miui/gallery/view/menu/MenuPresenter;
    ...
    :cond_1
    invoke-interface {v4}, Lcom/miui/gallery/view/menu/MenuPresenter;->flagActionItems()Z
    ...
    iget-object v0, p0, Lcom/miui/gallery/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/miui/gallery/view/menu/MenuBuilder;->mActionItems:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v3, p0, Lcom/miui/gallery/view/menu/MenuBuilder;->mNonActionItems:Ljava/util/ArrayList;
...
.method public getVisibleItems()Ljava/util/ArrayList;
    ...
    iget-boolean v0, p0, Lcom/miui/gallery/view/menu/MenuBuilder;->mIsVisibleItemsStale:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Lcom/miui/gallery/view/menu/MenuBuilder;->mVisibleItems:Ljava/util/ArrayList;
...
.method public performItemAction(Landroid/view/MenuItem;I)Z
    ...
    :cond_0
    invoke-virtual {p1}, Lcom/miui/gallery/view/menu/MenuItemImpl;->invoke()Z

    move-result v1

    invoke-virtual {p1}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getSupportActionProvider()Landroid/view/ActionProvider;
    ...
    invoke-virtual {p1}, Lcom/miui/gallery/view/menu/MenuItemImpl;->expandActionView()Z
    ...
    :cond_2
    invoke-virtual {p1}, Lcom/miui/gallery/view/menu/MenuItemImpl;->hasSubMenu()Z
    ...
    invoke-direct {p2, v0, p0, p1}, Lcom/miui/gallery/view/menu/SubMenuBuilder;-><init>(Landroid/content/Context;Lcom/miui/gallery/view/menu/MenuBuilder;Lcom/miui/gallery/view/menu/MenuItemImpl;)V

    invoke-virtual {p1, p2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->setSubMenu(Lcom/miui/gallery/view/menu/SubMenuBuilder;)V

    :cond_5
    invoke-virtual {p1}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getSubMenu()Landroid/view/SubMenu;
    ...
    :cond_6
    invoke-direct {p0, p1}, Lcom/miui/gallery/view/menu/MenuBuilder;->dispatchSubMenuSelected(Lcom/miui/gallery/view/menu/SubMenuBuilder;)Z
...
.method public removeGroup(I)V
    ...
    invoke-virtual {v3}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getGroupId()I
...
.method setExclusiveItemChecked(Landroid/view/MenuItem;)V
    ...
    invoke-virtual {v2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->getGroupId()I

    move-result v3

    if-ne v3, v0, :cond_0

    invoke-virtual {v2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->isExclusiveCheckable()Z
    ...
    :cond_1
    invoke-virtual {v2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->isCheckable()Z
    ...
    :goto_1
    invoke-virtual {v2, v3}, Lcom/miui/gallery/view/menu/MenuItemImpl;->setCheckedInt(Z)V
...
.method public setGroupCheckable(IZZ)V
    ...
    invoke-virtual {v1, p3}, Lcom/miui/gallery/view/menu/MenuItemImpl;->setExclusiveCheckable(Z)V

    invoke-virtual {v1, p2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->setCheckable(Z)Landroid/view/MenuItem;
...
.method public setGroupEnabled(IZ)V
    ...
    invoke-virtual {v1, p2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->setEnabled(Z)Landroid/view/MenuItem;
...
.method public setGroupVisible(IZ)V
    ...
    invoke-virtual {v2, p2}, Lcom/miui/gallery/view/menu/MenuItemImpl;->setVisibleInt(Z)Z
