...
.method private determineTargetPage(IFII)I
    ...
    iget v1, p0, Lcom/miui/gallery/widget/ViewPager;->mReverseVelocity:I
    ...
    const-string v6, "go on scrolling to new page, offset: "
    ...
    const-string v5, "deltaX: %s, velocity: %s, offset: %s, curItem: %s, displayItem: %s, tarItem: %s"
...
.method private findPointerIndex(Landroid/view/MotionEvent;I)I
    ...
    const-string v2, "invalid_pointer"

    sget-object v3, Ljava/util/Locale;->US:Ljava/util/Locale;

    const-string v4, "id[%d], index[%d], count[%d]"
...
.method private pageScrolled(IZ)Z
    ...
    iput-boolean v0, p0, Lcom/miui/gallery/widget/ViewPager;->mCalledSuper:Z

    const/4 p1, 0x0

    invoke-virtual {p0, v0, p1, v0}, Lcom/miui/gallery/widget/ViewPager;->onPageScrolled(IFI)V
    ...
    iget v4, p2, Lcom/miui/gallery/widget/ViewPager$ItemInfo;->position:I

    int-to-float p1, p1

    div-float/2addr p1, v1

    iget v1, p2, Lcom/miui/gallery/widget/ViewPager$ItemInfo;->offset:F

    sub-float/2addr p1, v1

    iget v1, p2, Lcom/miui/gallery/widget/ViewPager$ItemInfo;->offsetLeftScreen:F
    ...
    invoke-virtual {p0, v4, p1, p2}, Lcom/miui/gallery/widget/ViewPager;->onPageScrolled(IFI)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v12, v0, Lcom/miui/gallery/widget/ViewPager;->mMarginDrawable:Landroid/graphics/drawable/Drawable;
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v1, v6, Lcom/miui/gallery/widget/ViewPager;->mLastMotionX:F
    ...
    iput-boolean v9, v6, Lcom/miui/gallery/widget/ViewPager;->mIsUnableToDrag:Z
    ...
    :cond_d
    iput-boolean v9, v6, Lcom/miui/gallery/widget/ViewPager;->mIsBeingDragged:Z

    invoke-direct {v6, v9}, Lcom/miui/gallery/widget/ViewPager;->setScrollState(I)V
    ...
    :goto_1
    invoke-direct {v6, v9}, Lcom/miui/gallery/widget/ViewPager;->setScrollingCacheEnabled(Z)V
    ...
    iget-object v1, v6, Lcom/miui/gallery/widget/ViewPager;->mScroller:Landroid/widget/Scroller;
    ...
    iget v1, v6, Lcom/miui/gallery/widget/ViewPager;->mCloseEnough:I
    ...
    iget v2, v6, Lcom/miui/gallery/widget/ViewPager;->mLastMotionY:F
    ...
    iget-boolean v2, v6, Lcom/miui/gallery/widget/ViewPager;->mIsBeingDragged:Z
    ...
    iget-boolean v2, v6, Lcom/miui/gallery/widget/ViewPager;->mIsUnableToDrag:Z
...
.method protected onLayout(ZIIII)V
    ...
    invoke-virtual {v14, v1, v13, v15, v2}, Landroid/view/View;->layout(IIII)V
    ...
    :cond_d
    iput v9, v0, Lcom/miui/gallery/widget/ViewPager;->mTopPageBounds:I
...
.method protected onMeasure(II)V
    ...
    iget v10, v0, Lcom/miui/gallery/widget/ViewPager;->mChildWidthMeasureSpec:I
...
.method public performAccessibilityAction(ILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p2}, Lcom/miui/gallery/widget/PagerAdapter;->getCount()I
...
.method populate(I)V
    ...
    const-string v0, "populate is pending, skipping for now..."
    ...
    check-cast v7, Lcom/miui/gallery/widget/ViewPager$ItemInfo;

    iget v8, v7, Lcom/miui/gallery/widget/ViewPager$ItemInfo;->position:I

    iget v9, p0, Lcom/miui/gallery/widget/ViewPager;->mCurItem:I
    ...
    invoke-virtual {p0, v3, v6}, Lcom/miui/gallery/widget/ViewPager;->addNewItem(II)Lcom/miui/gallery/widget/ViewPager$ItemInfo;
    ...
    iget v3, p0, Lcom/miui/gallery/widget/ViewPager;->mLeftOffscreenPageLimit:I

    iget v8, p0, Lcom/miui/gallery/widget/ViewPager;->mRightOffscreenPageLimit:I

    if-gt v3, v8, :cond_9

    invoke-direct {p0, v7, v6, p1}, Lcom/miui/gallery/widget/ViewPager;->populateLeft(Lcom/miui/gallery/widget/ViewPager$ItemInfo;II)I

    move-result p1

    invoke-direct {p0, v7, p1, v4}, Lcom/miui/gallery/widget/ViewPager;->populateRight(Lcom/miui/gallery/widget/ViewPager$ItemInfo;II)I
    ...
    :cond_9
    invoke-direct {p0, v7, v6, v4}, Lcom/miui/gallery/widget/ViewPager;->populateRight(Lcom/miui/gallery/widget/ViewPager$ItemInfo;II)I

    move-result v3

    invoke-direct {p0, v7, v3, p1}, Lcom/miui/gallery/widget/ViewPager;->populateLeft(Lcom/miui/gallery/widget/ViewPager$ItemInfo;II)I

    move-result p1

    :goto_4
    invoke-direct {p0, v7, p1, v0}, Lcom/miui/gallery/widget/ViewPager;->calculatePageOffsets(Lcom/miui/gallery/widget/ViewPager$ItemInfo;ILcom/miui/gallery/widget/ViewPager$ItemInfo;)V
    ...
    const-string v0, "Current page list:"
    ...
    iget-object v3, v7, Lcom/miui/gallery/widget/ViewPager$ItemInfo;->object:Ljava/lang/Object;
    ...
    :goto_6
    invoke-virtual {p1, p0, v0, v3}, Lcom/miui/gallery/widget/PagerAdapter;->setPrimaryItem(Landroid/view/ViewGroup;ILjava/lang/Object;)V
    ...
    iput v3, v4, Lcom/miui/gallery/widget/ViewPager$LayoutParams;->widthFactor:F
