.class final Lcom/miui/gallery/util/CryptoUtil$4;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/miui/gallery/util/CryptoUtil;->decryptFileHeader(Ljava/lang/String;Ljava/lang/String;[B)Z
.end annotation
...
.method constructor <init>(Ljava/io/FileInputStream;[B)V
    ...
    iput-object p1, p0, Lcom/miui/gallery/util/CryptoUtil$4;->val$inputStream:Ljava/io/FileInputStream;

    iput-object p2, p0, Lcom/miui/gallery/util/CryptoUtil$4;->val$key:[B
...
.method public handle(Ljava/io/FileOutputStream;)Ljava/lang/Boolean;
    ...
    :try_start_0
    iget-object v2, p0, Lcom/miui/gallery/util/CryptoUtil$4;->val$inputStream:Ljava/io/FileInputStream;
    ...
    iget-object v5, p0, Lcom/miui/gallery/util/CryptoUtil$4;->val$inputStream:Ljava/io/FileInputStream;
    ...
    const-string v3, "read encrypted header bytes error"
    ...
    :cond_1
    iget-object v5, p0, Lcom/miui/gallery/util/CryptoUtil$4;->val$key:[B

    invoke-static {v4, v5}, Lcom/miui/gallery/util/CryptoUtil;->access$100([B[B)[B
    ...
    const-string v3, "Encrypted file is malformed."
    ...
    const-string v3, "write decrypted header bytes error"
    ...
    const-string v3, "decrypt header bytes error"
...
.method public bridge synthetic handle(Ljava/io/FileOutputStream;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lcom/miui/gallery/util/CryptoUtil$4;->handle(Ljava/io/FileOutputStream;)Ljava/lang/Boolean;
