...
.method protected constructor <init>(Ljava/io/InputStream;)V
    ...
    iput p1, p0, Lcom/miui/gallery3d/exif/CountedDataInputStream;->mCount:I

    const/16 p1, 0x8

    new-array p1, p1, [B

    iput-object p1, p0, Lcom/miui/gallery3d/exif/CountedDataInputStream;->mByteArray:[B

    iget-object p1, p0, Lcom/miui/gallery3d/exif/CountedDataInputStream;->mByteArray:[B

    invoke-static {p1}, Ljava/nio/ByteBuffer;->wrap([B)Ljava/nio/ByteBuffer;

    move-result-object p1

    iput-object p1, p0, Lcom/miui/gallery3d/exif/CountedDataInputStream;->mByteBuffer:Ljava/nio/ByteBuffer;
...
.method public read()I
    ...
    iget-object v0, p0, Lcom/miui/gallery3d/exif/CountedDataInputStream;->in:Ljava/io/InputStream;

    invoke-virtual {v0}, Ljava/io/InputStream;->read()I

    move-result v0

    iget v1, p0, Lcom/miui/gallery3d/exif/CountedDataInputStream;->mCount:I
...
.method public read([BII)I
    ...
    iget p2, p0, Lcom/miui/gallery3d/exif/CountedDataInputStream;->mCount:I
    ...
    iput p2, p0, Lcom/miui/gallery3d/exif/CountedDataInputStream;->mCount:I
...
.method public readOrThrow([B)V
    ...
    invoke-virtual {p0, p1, v1, v0}, Lcom/miui/gallery3d/exif/CountedDataInputStream;->readOrThrow([BII)V
...
.method public readString(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/miui/gallery3d/exif/CountedDataInputStream;->readOrThrow([B)V
...
.method public skipTo(J)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/miui/gallery3d/exif/CountedDataInputStream;->skipOrThrow(J)V
