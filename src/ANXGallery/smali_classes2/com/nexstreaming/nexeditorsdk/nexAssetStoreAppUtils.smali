...
.method public static runAssetStoreApp(Landroid/app/Activity;Ljava/lang/String;I)I
    ...
    :cond_1
    const-string p1, "AssetStore.intent.extra.MimeType"

    sget v1, Lcom/nexstreaming/nexeditorsdk/nexAssetStoreAppUtils;->moveCategory:I
    ...
    const-string p1, "AssetStore.intent.extra.ConnectServer"
    ...
    const-string p1, "AssetStore.intent.extra.MarketId"
    ...
    :cond_3
    const-string p1, "AssetStore.intent.extra.Vendor"

    sget-object v1, Lcom/nexstreaming/nexeditorsdk/nexAssetStoreAppUtils;->vendor:Ljava/lang/String;

    invoke-virtual {v0, p1, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/lang/String;)Landroid/content/Intent;

    const-string p1, "AssetStore.intent.extra.SDKLevel"

    const/4 v1, 0x7

    invoke-virtual {v0, p1, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string p1, "AssetStore.intent.extra.ProtocolVersion"

    const/4 v1, 0x1

    invoke-virtual {v0, p1, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string p1, "AssetStore.intent.extra.UiSet.Categorys"

    sget v1, Lcom/nexstreaming/nexeditorsdk/nexAssetStoreAppUtils;->availableCategory:I

    invoke-virtual {v0, p1, v1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;I)Landroid/content/Intent;

    const-string p1, "AssetStore.intent.extra.DenyFeaturedList"
    ...
    const-string p1, "AssetStore.intent.extra.MimeTypeExtra"
    ...
    const-string p1, "nexAssetStoreAppUtils"

    new-instance v1, Ljava/lang/StringBuilder;

    invoke-direct {v1}, Ljava/lang/StringBuilder;-><init>()V

    const-string v2, "Set intent flag value="
