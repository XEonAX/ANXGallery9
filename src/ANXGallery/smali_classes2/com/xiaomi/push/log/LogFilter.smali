...
# static fields
.field private static MIPUSH_LOG_PATH:Ljava/lang/String; = "/MiPushLog"
...
.method private doFilter(Ljava/io/BufferedReader;Ljava/io/BufferedWriter;Ljava/util/regex/Pattern;)V
    ...
    iget-object v10, p0, Lcom/xiaomi/push/log/LogFilter;->mFromTime:Ljava/lang/String;
    ...
    iget-boolean v11, p0, Lcom/xiaomi/push/log/LogFilter;->mStartFound:Z

    if-nez v11, :cond_0

    iget-object v11, p0, Lcom/xiaomi/push/log/LogFilter;->mFromTime:Ljava/lang/String;
    ...
    iput-boolean v5, p0, Lcom/xiaomi/push/log/LogFilter;->mStartFound:Z
    ...
    :cond_0
    iget-object v11, p0, Lcom/xiaomi/push/log/LogFilter;->mEndTime:Ljava/lang/String;
    ...
    :cond_3
    :goto_3
    iget-boolean v4, p0, Lcom/xiaomi/push/log/LogFilter;->mStartFound:Z

    if-eqz v4, :cond_5

    sub-int/2addr v1, v9

    iget v4, p0, Lcom/xiaomi/push/log/LogFilter;->mCurrentLen:I

    add-int/2addr v4, v1

    iput v4, p0, Lcom/xiaomi/push/log/LogFilter;->mCurrentLen:I
    ...
    iget v1, p0, Lcom/xiaomi/push/log/LogFilter;->mCurrentLen:I

    iget v4, p0, Lcom/xiaomi/push/log/LogFilter;->mMaxLen:I
...
.method private filter2File(Ljava/io/File;)V
    ...
    iput p1, p0, Lcom/xiaomi/push/log/LogFilter;->mCurrentLen:I

    iget-object p1, p0, Lcom/xiaomi/push/log/LogFilter;->mFiles:Ljava/util/ArrayList;
    ...
    :try_start_2
    invoke-direct {p0, v4, v2, v0}, Lcom/xiaomi/push/log/LogFilter;->doFilter(Ljava/io/BufferedReader;Ljava/io/BufferedWriter;Ljava/util/regex/Pattern;)V
    ...
    invoke-virtual {p1}, Lcom/xiaomi/network/HostManager;->dump()Ljava/lang/String;
...
.method filter(Landroid/content/Context;Ljava/util/Date;Ljava/util/Date;Ljava/io/File;)Ljava/io/File;
    ...
    invoke-virtual {p0, v0}, Lcom/xiaomi/push/log/LogFilter;->addFile(Ljava/io/File;)Lcom/xiaomi/push/log/LogFilter;
    ...
    sget-object p1, Lcom/xiaomi/push/log/LogFilter;->MIPUSH_LOG_PATH:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/push/log/LogFilter;->addFile(Ljava/io/File;)Lcom/xiaomi/push/log/LogFilter;
    ...
    invoke-direct {p0, v0}, Lcom/xiaomi/push/log/LogFilter;->filter2File(Ljava/io/File;)V
    ...
    invoke-static {p1, v0}, Lcom/xiaomi/channel/commonutils/file/IOUtils;->zip(Ljava/io/File;Ljava/io/File;)V
...
.method setRange(Ljava/util/Date;Ljava/util/Date;)Lcom/xiaomi/push/log/LogFilter;
    ...
    iput-object p2, p0, Lcom/xiaomi/push/log/LogFilter;->mFromTime:Ljava/lang/String;

    iget-object p2, p0, Lcom/xiaomi/push/log/LogFilter;->dateFormatter:Ljava/text/SimpleDateFormat;

    invoke-virtual {p2, p1}, Ljava/text/SimpleDateFormat;->format(Ljava/util/Date;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lcom/xiaomi/push/log/LogFilter;->mEndTime:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/xiaomi/push/log/LogFilter;->mFromTime:Ljava/lang/String;

    iget-object p1, p0, Lcom/xiaomi/push/log/LogFilter;->dateFormatter:Ljava/text/SimpleDateFormat;
