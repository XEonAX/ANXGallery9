...
.method protected constructor <init>(Landroid/content/Context;Lcom/xiaomi/network/HostFilter;Lcom/xiaomi/network/HostManager$HttpGet;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance p2, Lcom/xiaomi/network/HostManager$1;

    invoke-direct {p2, p0}, Lcom/xiaomi/network/HostManager$1;-><init>(Lcom/xiaomi/network/HostManager;)V
...
.method public static addReservedHost(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v2, v3}, Lcom/xiaomi/network/Fallback;->setEffectiveDuration(J)V
...
.method public static declared-synchronized init(Landroid/content/Context;Lcom/xiaomi/network/HostFilter;Lcom/xiaomi/network/HostManager$HttpGet;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_1
    sget-object p4, Lcom/xiaomi/network/HostManager;->factory:Lcom/xiaomi/network/HostManager$HostManagerFactory;

    invoke-interface {p4, p0, p1, p2, p3}, Lcom/xiaomi/network/HostManager$HostManagerFactory;->createHostManager(Landroid/content/Context;Lcom/xiaomi/network/HostFilter;Lcom/xiaomi/network/HostManager$HttpGet;Ljava/lang/String;)Lcom/xiaomi/network/HostManager;
...
.method private requestRemoteFallbacks(Ljava/util/ArrayList;)Ljava/util/ArrayList;
    ...
    invoke-virtual {v8}, Lcom/xiaomi/network/Fallback;->isEffective()Z
    ...
    iget-object v8, v8, Lcom/xiaomi/network/Fallback;->host:Ljava/lang/String;
    ...
    :goto_3
    iget-object v4, v1, Lcom/xiaomi/network/HostManager;->sUserId:Ljava/lang/String;

    invoke-virtual {v1, v2, v0, v4, v7}, Lcom/xiaomi/network/HostManager;->getRemoteFallbackJSON(Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    new-instance v14, Lcom/xiaomi/network/WeightedHost;
    ...
    invoke-direct {v14, v13, v0}, Lcom/xiaomi/network/WeightedHost;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v6, v14}, Lcom/xiaomi/network/Fallback;->addHost(Lcom/xiaomi/network/WeightedHost;)V
    ...
    iput-object v10, v6, Lcom/xiaomi/network/Fallback;->country:Ljava/lang/String;

    iput-object v5, v6, Lcom/xiaomi/network/Fallback;->province:Ljava/lang/String;

    iput-object v8, v6, Lcom/xiaomi/network/Fallback;->isp:Ljava/lang/String;

    iput-object v9, v6, Lcom/xiaomi/network/Fallback;->ip:Ljava/lang/String;

    iput-object v7, v6, Lcom/xiaomi/network/Fallback;->city:Ljava/lang/String;
    ...
    invoke-virtual {v6, v12, v13}, Lcom/xiaomi/network/Fallback;->setPercent(D)V
    ...
    invoke-virtual {v6, v0}, Lcom/xiaomi/network/Fallback;->setDomainName(Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v12, v13}, Lcom/xiaomi/network/Fallback;->setEffectiveDuration(J)V

    :cond_c
    invoke-virtual {v6}, Lcom/xiaomi/network/Fallback;->getISP()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v1, v0}, Lcom/xiaomi/network/HostManager;->setCurrentISP(Ljava/lang/String;)V
    ...
    invoke-virtual {v9, v5, v6}, Lcom/xiaomi/network/Fallback;->setEffectiveDuration(J)V
    ...
    new-instance v12, Lcom/xiaomi/network/WeightedHost;
    ...
    invoke-direct {v12, v11, v13}, Lcom/xiaomi/network/WeightedHost;-><init>(Ljava/lang/String;I)V

    invoke-virtual {v9, v12}, Lcom/xiaomi/network/Fallback;->addHost(Lcom/xiaomi/network/WeightedHost;)V
    ...
    invoke-interface {v10, v7}, Lcom/xiaomi/network/HostFilter;->accept(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v5, v4}, Lcom/xiaomi/network/HostManager;->updateFallbacks(Ljava/lang/String;Lcom/xiaomi/network/Fallback;)V
...
.method protected fromJSON(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v3}, Lcom/xiaomi/network/Fallback;->fromJSON(Lorg/json/JSONObject;)Lcom/xiaomi/network/Fallback;

    move-result-object v1

    sget-object v3, Lcom/xiaomi/network/HostManager;->sReservedHosts:Ljava/util/Map;

    iget-object v4, v1, Lcom/xiaomi/network/Fallback;->host:Ljava/lang/String;
...
.method public getFallbacksByHost(Ljava/lang/String;Z)Lcom/xiaomi/network/Fallback;
    ...
    invoke-interface {v0, p1}, Lcom/xiaomi/network/HostFilter;->accept(Ljava/lang/String;)Z
    ...
    :cond_2
    new-instance p2, Lcom/xiaomi/network/HostManager$2;

    invoke-direct {p2, p0, p1, v0}, Lcom/xiaomi/network/HostManager$2;-><init>(Lcom/xiaomi/network/HostManager;Ljava/lang/String;Lcom/xiaomi/network/Fallback;)V
...
.method protected getRemoteFallbackJSON(Ljava/util/ArrayList;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    new-instance v2, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;

    const-string v3, "type"

    invoke-direct {v2, v3, p2}, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance p2, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;

    const-string v2, "conpt"

    sget-object v3, Lcom/xiaomi/network/HostManager;->sAppContext:Landroid/content/Context;

    invoke-static {v3}, Lcom/xiaomi/channel/commonutils/network/Network;->getActiveConnPoint(Landroid/content/Context;)Ljava/lang/String;
    ...
    invoke-direct {p2, v2, v3}, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p4, v2}, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p2, p4, p3}, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p4}, Lcom/xiaomi/channel/commonutils/string/XMStringUtils;->join(Ljava/util/Collection;Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    invoke-direct {p2, p3, p1}, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {v1, p2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p1, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;

    const-string p2, "countrycode"

    sget-object p3, Lcom/xiaomi/network/HostManager;->sAppContext:Landroid/content/Context;

    invoke-static {p3}, Lcom/xiaomi/push/service/AppRegionStorage;->getInstance(Landroid/content/Context;)Lcom/xiaomi/push/service/AppRegionStorage;

    move-result-object p3

    invoke-virtual {p3}, Lcom/xiaomi/push/service/AppRegionStorage;->getCountryCode()Ljava/lang/String;

    move-result-object p3

    invoke-direct {p1, p2, p3}, Lcom/xiaomi/channel/commonutils/network/BasicNameValuePair;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, p4}, Lcom/xiaomi/network/Fallback;->getHosts(Z)Ljava/util/ArrayList;
    ...
    :cond_3
    invoke-virtual {p1, p2}, Lcom/xiaomi/network/Fallback;->getUrls(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    invoke-static {p4, v0}, Lcom/xiaomi/channel/commonutils/network/Network;->downloadXml(Landroid/content/Context;Ljava/net/URL;)Ljava/lang/String;
    ...
    invoke-interface {p4, p3}, Lcom/xiaomi/network/HostManager$HttpGet;->doGet(Ljava/lang/String;)Ljava/lang/String;
...
.method protected toJSON()Lorg/json/JSONObject;
    ...
    invoke-virtual {v4}, Lcom/xiaomi/network/Fallback;->toJSON()Lorg/json/JSONObject;
