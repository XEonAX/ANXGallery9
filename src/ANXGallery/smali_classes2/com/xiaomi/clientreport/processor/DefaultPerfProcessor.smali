...
.method public static getFirstPerfFileName(Lcom/xiaomi/clientreport/data/BaseClientReport;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/xiaomi/clientreport/data/BaseClientReport;->clientInterfaceId:Ljava/lang/String;
...
.method private getOriginalFilePath(Lcom/xiaomi/clientreport/data/BaseClientReport;)Ljava/lang/String;
    ...
    iget v1, p1, Lcom/xiaomi/clientreport/data/BaseClientReport;->production:I

    iget-object p1, p1, Lcom/xiaomi/clientreport/data/BaseClientReport;->clientInterfaceId:Ljava/lang/String;
    ...
    :cond_0
    iget-object p1, p0, Lcom/xiaomi/clientreport/processor/DefaultPerfProcessor;->mContext:Landroid/content/Context;
...
.method public preProcess(Lcom/xiaomi/clientreport/data/BaseClientReport;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/xiaomi/clientreport/processor/DefaultPerfProcessor;->mPerfMap:Ljava/util/HashMap;
    ...
    invoke-static {p1}, Lcom/xiaomi/clientreport/processor/DefaultPerfProcessor;->getFirstPerfFileName(Lcom/xiaomi/clientreport/data/BaseClientReport;)Ljava/lang/String;

    move-result-object v0

    invoke-static {p1}, Lcom/xiaomi/clientreport/processor/PerfKVFileHelper;->generateKey(Lcom/xiaomi/clientreport/data/PerfClientReport;)Ljava/lang/String;

    move-result-object v1

    iget-object v2, p0, Lcom/xiaomi/clientreport/processor/DefaultPerfProcessor;->mPerfMap:Ljava/util/HashMap;
    ...
    iget-object p1, p0, Lcom/xiaomi/clientreport/processor/DefaultPerfProcessor;->mPerfMap:Ljava/util/HashMap;
...
.method public process()V
    ...
    invoke-virtual {p0, v2}, Lcom/xiaomi/clientreport/processor/DefaultPerfProcessor;->write([Lcom/xiaomi/clientreport/data/BaseClientReport;)V
...
.method public readAndSend()V
    ...
    invoke-static {v4, v5}, Lcom/xiaomi/clientreport/processor/PerfKVFileHelper;->extractToDatas(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;

    move-result-object v4

    invoke-virtual {v3}, Ljava/io/File;->delete()Z

    invoke-virtual {p0, v4}, Lcom/xiaomi/clientreport/processor/DefaultPerfProcessor;->send(Ljava/util/List;)V
...
.method public write([Lcom/xiaomi/clientreport/data/BaseClientReport;)V
    ...
    :cond_0
    invoke-static {v0, p1}, Lcom/xiaomi/clientreport/processor/PerfKVFileHelper;->put(Ljava/lang/String;[Lcom/xiaomi/clientreport/data/BaseClientReport;)V
