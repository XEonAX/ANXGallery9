...
..\ANXMiuiPortTools\hub.exe release create -a .\out\ANXGalleryUnity_%anxversion%.zip -m singularity.%anxversion% %anxversioncode%.singularity
REM ..\ANXMiuiPortTools\hub.exe release edit -a .\out\ANXGalleryUnity_%anxversion%.zip -m singularity.%anxversion% %anxversioncode%.singularity
